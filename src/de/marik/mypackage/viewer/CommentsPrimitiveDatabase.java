...
//			"Exellent!", "Correct!", "Молодец!", "Korrekt!", "Умница!", "Так держать!", "Good!", "Exactly!"));
	...
	//without Russian
	private final ArrayList<String> positiveFeedbackList = new ArrayList<String>(Arrays.asList("Richtig!", "Well done!",
			"Sehr gut!", "Prima!", "Super!", "Großartig!", "Rechenprofi!", "Toll!", "Bravo!",
			"Exellent!", "Correct!", "Korrekt!", "Good!", "Exactly!"));
